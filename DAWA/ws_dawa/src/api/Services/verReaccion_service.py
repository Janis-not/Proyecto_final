...
from ws_dawa.src.api.Components.verReaccion_component import VerReaccionComponent
from flask import request
from flask_restful import Resource


class VerReaccionService(Resource):
    @staticmethod
    def get():
        try:
            ...
            resultado = VerReaccionComponent.getReacciones(c_publicacion_id)
            if resultado['result']:
