...
from ws_dawa.src.api.Components.verUsuarios_component import UsuariosComponent
from flask import request
from flask_restful import Resource


class AllUserService(Resource):
    @staticmethod
    def get():
        try:
            HandleLogs.write_log("Ejecutando servicio de Listar Usuario")  # Log the execution
            resultado = UsuariosComponent.getAllUsuarios()  # Fetch faculties data
