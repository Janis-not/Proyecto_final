...
from ws_dawa.src.api.Components.verpublicacionUsuario_componet import verPublicacionUsuarioComponent
from flask import request
from flask_restful import Resource


class VerPublicacionUsuarioService(Resource):
    @staticmethod
    def get():
        try:
            ...
            resultado = verPublicacionUsuarioComponent.getPublicacionUsuario(c_estudiante_id)
            if resultado['result']:
